...
public:
    subforwardlist(subforwardlist **sfl);
...
subforwardlist::subforwardlist(subforwardlist **sfl){
*sfl=NULL;
}
bool subforwardlist::push_back(subforwardlist **sfl, int d){
if(!(*sfl)) {
subforwardlist(**sfl);
(*sfl)->data = d;
(*sfl)->next = NULL;
...
subforwardlist *copy_sfl = *sfl;
while (copy_sfl->next){
       copy_sfl = copy_sfl->next;
}
subforwardlist(*a);
a->data = d;
a->next = NULL;
...
int subforwardlist::pop_back(subforwardlist **sfl){
if (!(*sfl)) return 0;
if (!(*sfl)->next){
        int a = (*sfl)->data;
        delete *sfl;
...
subforwardlist *copy_sfl = *sfl;
    while(copy_sfl->next->next){
        copy_sfl = copy_sfl->next;
    }
int a = copy_sfl->next->data;
delete copy_sfl->next;
copy_sfl->next = NULL;
return(a);
}
bool subforwardlist::push_forward(subforwardlist **sfl, int d){
subforwardlist (*temp);
temp->data = d;
temp->next = *sfl;
*sfl = temp;
...
int subforwardlist::pop_forward(subforwardlist **sfl){
if (!(*sfl)) return 0;
int a = (*sfl)->data;
subforwardlist *copy_sfl = (*sfl)->next;
delete *sfl;
*sfl = copy_sfl;
return(a);
}
unsigned int subforwardlist::size(subforwardlist  **sfl){
if (!(*sfl)) return 0;
unsigned int k = 1;
subforwardlist *copy_sfl=*sfl;
while (copy_sfl->next){
...
bool subforwardlist::push_where(subforwardlist **sfl, unsigned int where, int d){
if (!(*sfl)) push_forward(sfl,d);
unsigned int k = 0;
subforwardlist *copy_sfl = *sfl;
if (where == 0){
push_forward(sfl,d);
...
subforwardlist(*temp);
temp->data = d;
temp->next = copy_sfl->next;
copy_sfl->next = temp;
return(true);
}
int subforwardlist::erase_where(subforwardlist **sfl, unsigned int where){
if (!(*sfl)) return 0;
unsigned int k=0;
subforwardlist *copy_sfl = *sfl;
...
int a = copy_sfl->next->data;
subforwardlist *next_copy_sfl = copy_sfl->next->next;
delete copy_sfl->next;
copy_sfl->next = next_copy_sfl;
return(a);
}
